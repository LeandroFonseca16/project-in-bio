...
import UserCard from "@/app/commons/user-cards";
    ...
    return(
        <div className="relative h-screen flex p-20 overflow-hidden">
            <div className="fixed top-0 left-0 w-full flex justify-center items-center gap-1 py-2 bg-background-tertiary">
                ...
                <Link href={`?${profileId}/upgrade`}> {/*aqui estamos utilizando o promisse, ele é um objeto que espera o resultado de maneira assíncrona */}
